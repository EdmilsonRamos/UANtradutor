...
// Opções avançadas
var avançada = document.getElementById("avançada");

    avançada.addEventListener('change', function(){

        var selectedIndex= avançada.selectedIndex;
        if(selectedIndex ===1){
